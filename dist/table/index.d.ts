...
interface TableOptions {
     ...
     * @default TableView
     */
    View: (new (node: Node, cellMinWidth: number, view: EditorView) => NodeView) | undefined;
    /**
...
export { ColGroup, DEFAULT_CELL_LINE_SEPARATOR, Table, TableOptions, createColGroup, createTable, renderTableToMarkdown };
