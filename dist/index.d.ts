...
interface TableOptions {
     ...
     * @default TableView
     */
    View: (new (node: Node$1, cellMinWidth: number, view: EditorView) => NodeView) | undefined;
    /**
...
declare class TableView implements NodeView {
    ...
    private hasSetInitialWidths;
    constructor(node: Node$1, cellMinWidth: number, view: EditorView, getPos: () => number | undefined);
    private checkIfNeedsInitialWidths;
    private captureAndSetInitialWidths;
...
export { ColGroup, DEFAULT_CELL_LINE_SEPARATOR, Table, TableCell, TableCellOptions, TableHeader, TableHeaderOptions, TableKit, TableKitOptions, TableOptions, TableRow, TableRowOptions, TableView, createColGroup, createTable, renderTableToMarkdown, updateColumns };
